...
public class FFExpansionHubs implements ISubsystem {
    private FreightFrenzyAutoRobot robot;
    ...
    public FFExpansionHubs(FreightFrenzyAutoRobot robot, ExpansionHubEx masterHub, ExpansionHubEx slaveHub) {
        setRobot(robot);
    ...
    public FreightFrenzyAutoRobot getRobot() {
        return robot;
    }

    public void setRobot(FreightFrenzyAutoRobot robot) {
        this.robot = robot;
    }
