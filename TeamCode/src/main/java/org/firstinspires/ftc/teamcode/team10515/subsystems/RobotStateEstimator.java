...
public class RobotStateEstimator implements ISubsystem {
    private FreightFrenzyRobot skystoneRobot;
    private BNO055IMU imu;
    private volatile Pose2d pose;
    private volatile Pose2d lastPose;
    private Pose2d velocityPose;

    public RobotStateEstimator(FreightFrenzyRobot skystoneRobot, BNO055IMU imu, Pose2d initialPose) {
    ...
    public FreightFrenzyRobot getSkystoneRobot() {
        return skystoneRobot;
    }

    public void setSkystoneRobot(FreightFrenzyRobot skystoneRobot) {
