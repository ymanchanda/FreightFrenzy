 ...
 */
public class FreightFrenzyAutoRobot{
...
//        );
        ...
        setIntakeMotorSubsystem(new IntakeSubsystem(getMotors()[0]));
        setElevSubsystem(new ElevSubsystem(getMotors()[1]));
        setCarouselSubsystem(new CarouselSubsystem(getMotors()[2]));
